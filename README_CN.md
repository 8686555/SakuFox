...
如果你想从不同角度理解这个项目，可以直接看这两篇说明：

- [技术视角：AI 问数为什么不只是 NL2SQL](docs/technical-perspective.md)
- [产品视角：为什么 AI 问数要做成组织认知系统](docs/product-perspective.md)
...
- [技术视角版](docs/technical-perspective.md)
- [产品视角版](docs/product-perspective.md)
